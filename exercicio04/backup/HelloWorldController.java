...
public class HelloWorldController {
    ...
    public String olaMundo() {
        return helloWorldService.gerarOlaMundo(returnMensagem(lista_nomes,lista_sobrenomes,lista_posicoes,lista_clube));
    }

    @GetMapping("/mensagemJson")
    public String olaMundo2() {
        return helloWorldService.gerarOlaMundo(returnMensagemJSON(lista_nomes,lista_sobrenomes,lista_posicoes,lista_clube));
    }
}
